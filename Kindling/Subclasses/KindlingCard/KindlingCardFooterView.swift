...
class KindlingCardFooterView: UIView {
    ...
    init(viewModel: CardViewModel) {
        ...
        clipsToBounds = true
        isOpaque = false
        initialize(title: "\(viewModel.username) \(viewModel.flag)", subtitle: "\(viewModel.age) years / \(viewModel.formattedDOB) 🥳🎂")
    }
